...
<script>
const byId=id=>document.getElementById(id);let snapshot=null,learning=null,selectedAttemptId=null,blobPreview=null,promptPreview=null;
...
function humanEditor(){return '<div class="human-actions"><input id="human-text" placeholder="Human feedback or approval evidence"><button data-learning-action="feedback">Send feedback</button><button data-learning-action="approve">Approve with exact-head evidence</button></div>'}
