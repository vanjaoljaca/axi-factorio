...
type ViewBlob = {
  ...
  paused: boolean;
  running: boolean;
  status: "ready" | "running" | "waiting" | "blocked" | "failed" | "complete";
...
<div class="footer"><div class="legend"><span><i class="key complete"></i>Completed</span><span><i class="key imported"></i>Imported</span><span><i class="key current"></i>Current</span><span><i class="key waiting"></i>Awaiting review</span><span><i class="key"></i>Pending</span><span><i class="key failed"></i>Failed</span></div><span class="total" id="total"></span></div>
...
function statusLabel(status){return {running:'Running',waiting:'Awaiting review',blocked:'Blocked',failed:'Failed'}[status]||''}
