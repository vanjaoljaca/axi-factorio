...
type ViewSnapshot = {
  ...
  visual?: HappyPathVisual | LiveExecutionVisual | ViewerResilienceVisual | CursorActionVisual | LocalEndpointVisual | OverviewBoundaryVisual | ProjectRemovalVisual | AggregatePollingVisual | ActiveProjectsVisual | AxiValidationVisual | ServiceRecoveryVisual;
};
