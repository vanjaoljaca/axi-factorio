...
:root{color-scheme:dark;--bg:#0b0e0d;--panel:#121715;--line:#29322e;--muted:#83918a;--ink:#ecf2ef;--acid:#b7f34a;--amber:#ffbd59;--red:#ff6b6b;--cyan:#6dd6d2}
...
button{font:inherit}.shell{min-height:100vh;display:grid;grid-template-columns:240px 1fr}.rail{border-right:1px solid var(--line);padding:20px 14px;background:#0e1210}
...
.source,.scenario{width:100%;text-align:left;border:1px solid transparent;background:transparent;color:var(--muted);padding:9px 10px;border-radius:6px;cursor:pointer}.source.active,.scenario.active{background:var(--panel);color:var(--ink);border-color:var(--line)}.scenario small{display:block;color:#59645f}
...
.actions{margin-left:auto;display:flex;gap:8px}.btn{border:1px solid var(--line);background:#18201c;color:var(--ink);padding:8px 11px;border-radius:5px;cursor:pointer}.btn.primary{background:var(--acid);color:#111;border-color:var(--acid);font-weight:800}
...
.blob{border:1px solid #3b4842;background:#1a221e;border-left:3px solid var(--acid);border-radius:6px;padding:10px;margin-bottom:8px}.blob.running{border-left-color:var(--cyan)}.blob.blocked,.blob.failed{border-left-color:var(--red)}.blob.completed{border-left-color:var(--acid);opacity:.68}.blobid{font-size:10px;color:var(--muted)}.blobtitle{margin:3px 0 8px}.badge{display:inline-block;border:1px solid var(--line);padding:2px 5px;border-radius:3px;font-size:10px;color:var(--cyan)}
.lower{display:grid;grid-template-columns:1fr 310px;gap:16px;min-height:0}.timeline,.checks{overflow:auto}.event{display:grid;grid-template-columns:55px 120px 150px 1fr;gap:10px;padding:8px 12px;border-bottom:1px solid #202824}.event span{color:var(--muted)}.event b{font-weight:500}.empty{height:100%;display:grid;place-items:center;color:var(--muted);text-align:center}.check{padding:10px 12px;border-bottom:1px solid #202824}.pass{color:var(--acid)}.fail{color:var(--red)}.pulse{animation:pulse .65s ease}@keyframes pulse{50%{filter:brightness(1.6)}}@media(max-width:850px){.shell{grid-template-columns:1fr}.rail{display:none}.lower{grid-template-columns:1fr}.checks{display:none}}
